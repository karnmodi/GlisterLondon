...
export interface ContactInquiry {
  ...
  email: string
  phone?: string
  category?: 'general_inquiry' | 'product_inquiry' | 'order_status' | 'refund_request' | 'bulk_order' | 'business_inquiry' | 'technical_support' | 'shipping_delivery' | 'payment_issue' | 'complaint' | 'other'
  subject: string
  message: string
