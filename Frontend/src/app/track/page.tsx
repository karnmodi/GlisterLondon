          ...
          >
            <form onSubmit={handleTrackOrder}>
              ...
              <p className="mt-3 text-xs text-ivory/50 text-center">
                Enter the order number (e.g., BU202411190001) and email address you used when placing the order
              </p>
            </form>
          </motion.div>
                ...
                <div className="lg:col-span-2 space-y-4">
                  ...
                  {order.orderNotes && (
                    <div className="bg-charcoal/95 backdrop-blur-md border border-brass/20 rounded-lg p-4 sm:p-6">
                      ...
                      <p className="text-ivory/70 text-sm">{order.orderNotes}</p>
                    </div>
                  )}
                </div>
