      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          >
            ...
            {/* Order Notes - only shown when the customer added one at checkout */}
            {order.orderNotes && (
              <div className="mt-5 bg-brass/10 rounded-lg p-3 border border-brass/20">
                <h3 className="text-xs font-bold text-brass mb-2 uppercase tracking-wide flex items-center gap-1.5">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-charcoal text-sm whitespace-pre-wrap">{order.orderNotes}</p>
              </div>
            )}
          </motion.div>
