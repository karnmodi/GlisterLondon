...
const aboutUsData = [
	// About Section
	{
		section: 'about',
		title: 'About Britlyn',
		content: `Britlyn is not a product. It is a feeling — the quiet pride you feel when beauty meets precision, when craftsmanship meets soul.

Born in the heart of Britain, Britlyn stands as a symbol of heritage, artistry, and enduring luxury. We craft architectural hardware that transforms houses into homes of distinction — every handle, every curve, every finish designed to whisper sophistication.
...
For those who understand that true refinement lies in the smallest details — Britlyn is not an accessory. It is your home's signature.

Britlyn — The Emotion of Craft. The Pride of Your Home.`,
		order: 0,
		isActive: true,
	},
	...
	// Philosophy Section
	{
		section: 'philosophy',
		title: 'Philosophy',
		content: `We believe every home deserves more than perfection. It deserves character, heritage, and a soul. At Britlyn, we design for legacy, not trends.`,
		order: 0,
		isActive: true,
	},
	...
	// Promise Section
	{
		section: 'promise',
		title: 'Promise',
		content: `Each Britlyn creation is made to last a lifetime — not only in function but in feeling. A fusion of British tradition, modern artistry, and uncompromising quality.`,
		order: 0,
		isActive: true,
	},
